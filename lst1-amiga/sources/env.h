...
# define TEMPFILE "ram:stXXXXXX"
# define PARSER   "Smalltalk:parser/parse"
# define PRELUDE  "Smalltalk:prelude/standard"
# define FAST     "Smalltalk:prelude/stdsave"
# define LIBLOC	  "Smalltalk:lib"
